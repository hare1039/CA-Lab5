...
void simulate(int associativity, int cache_size, int block_size, const char *file_name)
{
    ...
    int index_bit  = static_cast<int>( log2(cache_size/block_size/associativity) );
    ...
    std::cout << "number_lookup:\t" << number_lookup << std::endl;
    std::cout << "number_miss:\t"   << number_miss   << std::endl;
    std::cout << "miss rate:\t"     << static_cast<double>(number_miss)/number_lookup << std::endl;
    std::cout << std::endl;
